package kolokviumski.kol1.zad36;
...
class Car implements Comparable<Car>{
    ...
    private int price;
    private int power;
    public Car(String manufacturer, String model, int price, int power){
...
class CarCollection{
    ...
    public void sortByPrice(boolean ascending){
        ...
        else cars = cars.stream().sorted(Comparator.reverseOrder()).collect(Collectors.toList());
    }
