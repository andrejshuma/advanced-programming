package kolokviumski.kol1.zad37;
...
class Airports{
    ...
    public void addFlights(String from, String to, int time, int duration){
        ...
        fromAirport.addFlight(from, to, time, duration);
    }
    ...
    public void showDirectFlightsFromTo(String from, String to){
        Airport fromAirport = airportMap.get(from);
        Set<Flight> flights = fromAirport.getFlights().get(to);
        if (flights != null) {
    ...
    public void showDirectFlightsTo(String to){
        ...
        airportMap.values().forEach(airport -> {
            Set<Flight> fs = airport.getFlights().get(to);
            if (fs != null) flights.addAll(fs);
        });
